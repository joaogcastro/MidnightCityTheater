...
namespace MidnightCityTheater.Migrations
{
    ...
    [Migration("20230927012933_CriacaoDatabase")]
            ...
            modelBuilder.Entity("MidnightCityTheater.Models.Cliente", b =>
                {
                    b.HasOne("MidnightCityTheater.Models.Venda", "Venda")
                        .WithOne("Cliente")
                        .HasForeignKey("MidnightCityTheater.Models.Cliente", "VendaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MidnightCityTheater.Models.Snack", b =>
                {
                    b.HasOne("MidnightCityTheater.Models.Venda", "Venda")
                        .WithOne("Snack")
                        .HasForeignKey("MidnightCityTheater.Models.Snack", "VendaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
